...
# User Guidance
Step 1 -> First user need to download project file go trough the github link and get .env code in other uploaded folder in DLE after that create .env file and copy paste that code into there.
